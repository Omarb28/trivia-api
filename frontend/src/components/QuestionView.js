    ...
    return (
      <div className="question-view">
        <div className="categories-list">
          <h2 className="category clickable" onClick={() => {this.getQuestions()}}>Categories</h2>
          <ul>
            {this.state.categories.map(category => {
              return (
              <li className="category clickable" key={category.id} onClick={() => {this.getByCategory(category.id)}}>
                {category.type}
